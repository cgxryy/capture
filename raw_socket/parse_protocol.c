// =====================================================================================
// 
//       Filename:  parse_protocol.c
//
//    Description:  
//
//        Version:  1.0
//        Created:  2015年02月27日 21时04分12秒
//       Revision:  none
//       Compiler:  g++
//
...
// 数据链路层解析
static void data_link_layer_parse(const u_char *proto_buf, int length);

// 网络层协议及其高层协议解析
static void ip_protocal_parse(const u_char *proto_buf, int length);

// ICMP协议解析
static void icmp_protocal_parse(const u_char *proto_buf, int length);

// TCP协议解析
static void tcp_protocal_parse(const u_char *proto_buf, int length);

// UDP协议解析
static void udp_protocal_parse(const u_char *proto_buf, int length);
